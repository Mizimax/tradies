#!/usr/bin/env python3
"""Run one BTCScalper MT5 candidate from the candidate matrix."""
...
def main() -> int:
    ...
    parser.add_argument("--matrix", type=Path, default=ROOT / "mt5/backtests/BTCSCALPER_CANDIDATES.csv")
    ...
    report_name = f"BTCScalper-{candidate['name'].strip()}"
