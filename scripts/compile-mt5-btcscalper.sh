...
SOURCE="$MT5_ROOT/MQL5/Experts/BTCScalper/BTCScalper.mq5"
SOURCE_DIR="$MT5_ROOT/MQL5/Experts/BTCScalper"
SOURCE_FILE="BTCScalper.mq5"
EX5="$MT5_ROOT/MQL5/Experts/BTCScalper/BTCScalper.ex5"
LOG="$MT5_ROOT/MQL5/Experts/BTCScalper/BTCScalper.log"
TMP_LOG="/tmp/btcscalper-metaeditor-compile.log"
...
require_file "$SOURCE" "BTCScalper source"
require_dir "$INCLUDE_DIR" "MT5 include directory"
require_dir "$INCLUDE_DIR/BTCScalper" "BTCScalper include directory"
for include_file in \
  SessionTime.mqh \
  RiskManager.mqh \
  Indicators.mqh \
...
echo "MetaEditor command-line compile did not update BTCScalper.ex5." >&2
echo "Source:   $SOURCE" >&2
echo "Compiled: $EX5" >&2
echo "Include:  $INCLUDE_ROOT" >&2
running_mt5="$(mt5_processes)"
