...
GOLDBOT="C:\\Program Files\\MetaTrader 5\\MQL5\\Experts\\GoldScalper\\GoldScalper.mq5"
...
WINEPREFIX="$PREFIX" "$WINE" "$METAEDITOR" "$GOLDBOT" >/tmp/GoldScalper-metaeditor.log 2>&1 &
echo "Opening MetaEditor for GoldScalper.mq5..."
