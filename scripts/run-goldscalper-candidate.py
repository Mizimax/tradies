#!/usr/bin/env python3
"""Run one GoldScalper MT5 candidate from the candidate matrix."""
...
def main() -> int:
    ...
    parser.add_argument("--matrix", type=Path, default=ROOT / "mt5/backtests/GOLDSCALPER_CANDIDATES.csv")
    ...
    env = {
        ...
        "MT5_EXPERT": "GoldScalper\\GoldScalper.ex5",
        "MT5_PRESET": "GoldScalper.optimized.set",
        "MT5_PERIOD": "M1",
    }
    if args.symbol:
